        ...
        <tbody>
            ...
            <![endif]-->
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_ereset o_bg-center o_b-default o_br o_px-md o_py-lg" align="left"
                                    background="images/hero_dots.png"
                                        ...
                                        <p class="o_text o_text-sans"
                                            ...
                                            <a class="o_text-dark o_link" href="#"
                                                style="transition: all .15s ease-in;color: #212932;text-decoration: none;outline: none;display: inline-block;"><img
                                                    ...
                                                    style="max-width: 52px;-ms-interpolation-mode: bicubic;display: block;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                                        </p>
                    ...
                    <![endif]-->
                                    <div class="o_col o_col-oo o_col-xs-4 o_of"
                                        style="width: 100%;vertical-align: top;max-width: 424px;display: inline-block !important;">
                                        <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                            <p class="o_text-lg o_text-sans o_text-muted o_mb-xs"
                                                style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;color: #687887;margin-top: 0px;margin-bottom: 8px;font-size: 20px;line-height: 30px;">
                                                Hello {{ $candidate->name }},</p>
                                            <h1 class="o_text-headline o_text-dark"
                                                style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;font-weight: bold;color: #212932;margin-top: 0px;margin-bottom: 0px;font-size: 32px;line-height: 41px;">
                                                Please confirm <br>
                                                your <span class="o_text-accent" style="color: #3ab7ff;">email
                                                    address</span></h1>
                                        </div>
                                    </div>
                                    <!--[if mso]>
                    ...
                    <![endif]-->
                                    <div class="o_col o_col-o o_of"
                                        style="width: 100%;vertical-align: top;max-width: 128px;display: inline-block !important;">
                                        <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="o_bg-white o_text o_text-sans o_text-dark o_p-icon o_br-max"
                                                            ...
                                                            <img class="o_br-max"
                                                                src="{{ asset('mail/images/icon_mail.gif') }}"
                                                                width="88" height="88" alt="Mail Envolope"
                                    ...
                                    <div>
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="o_bb-muted"
                                                        style="font-size: 24px;line-height: 24px;height: 24px;border-bottom: 4px solid #e9e9f1;">
                                                        &nbsp; </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <![endif]-->
                                    <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                        <p class="o_text-xs o_text-sans o_text-muted o_mt-md o_mb-md"
                                            style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;color: #687887;margin-top: 24px;margin-bottom: 24px;font-size: 14px;line-height: 21px;">
                                            Before you can participate on out {{ $test->name }} hosted by
                                            {{ website('name') ?? title() }} you'll need to confirm that <a
                                                class="o_text-muted" href="mailto:pierce.b@company.com"
                                                style="color: #687887;text-decoration: none;outline: none;display: inline-block;"><span
                                                    style="color: #687887;">{{ $candidate->email }}</span></a> is your
                                            email address. Follow the link below.</p>
                                        <table class="o_btn" role="presentation" cellspacing="0" cellpadding="0"
                                            border="0"
                                            style="transition: all .15s ease-in;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;">
                                            <tbody>
                                                <tr>
                                                    <td class="o_pbtn o_text-md o_br-max o_bg-default" align="center"
                                                        ...
                                                        <a class="o_text-headline o_text-white"
                                                            href="{{ route('website.test.verify', ['test' => $test->code, 'candidate' => $candidate->code]) }}"
                                                            style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;font-weight: bold;color: #ffffff;text-decoration: none;outline: none;display: block;"><span
                                                                style="color: #ffffff;">Confirm Email
                                                                Address</span></a>
                                                    </td>
                                                </tr>
                                            </tbody>
            ...
            <![endif]-->
                    <div class="o_col-6s o_text-sans o_text-xs o_text-left"
                        ...
                        <p class="o_text-muted o_mb-lg" style="color: #687887;margin-top: 0px;margin-bottom: 32px;">If
                        ...
                        <p class="o_text-headline o_text-xxs o_text-muted o_mb"
                            style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;font-weight: bold;font-size: 12px;line-height: 19px;text-transform: uppercase;letter-spacing: 1px;color: #687887;margin-top: 0px;margin-bottom: 16px;">
                            <a class="o_text-dark o_link" href="{{ route('website.test', ['test' => $test->code]) }}"
