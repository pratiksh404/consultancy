        ...
        <tbody>
            <tr>
                <td class="o_ereset o_bg-dark o_hide"
                    ...
                    <div>{{ $test->name }} participation notification.</div>
                    <div>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </td>
            ...
            <tr>
                <td class="o_ereset o_bg-dark o_pt-lg o_pb o_px-mg" align="center"
                    style="line-height: 100%;padding-left: 40px;padding-right: 40px;padding-top: 32px;padding-bottom: 16px;font-size: 0 !important;">
                    <!--[if mso]>
                            ...
                            <p class="o_text o_text-sans"
                                ...
                                <a class="o_text-dark o_link" href="#"
                                    style="transition: all .15s ease-in;color: #212932;text-decoration: none;outline: none;display: inline-block;"><img
                                        src="{{ logo() }}" alt="{{ website('name') ?? title() }}"
                                        style="max-width: 114px;-ms-interpolation-mode: bicubic;display: block;border: 0;line-height: 100%;height: 50px;outline: none;text-decoration: none;"></a>
                            </p>
                        </div>
                    </div>
                    <!--[if mso]>
                            ...
                            <p class="o_text-headline o_text-xxs o_text-muted"
                                ...
                                <a class="o_text-dark o_link"
                                    ...
                                    style="transition: all .15s ease-in;color: #212932;text-decoration: none;outline: none;display: inline-block;"><span
                                        style="color: #212932;">Test Profile</span></a> &nbsp; • &nbsp; <a
                                    class="o_text-dark o_link" href="{{ route('website.home') }}"
                                    style="transition: all .15s ease-in;color: #212932;text-decoration: none;outline: none;display: inline-block;"><span
            ...
            <td align="center">
            <![endif]-->
                    <table class="o_block" role="presentation" width="100%" cellspacing="0" cellpadding="0"
                        border="0"
                        style="max-width: 600px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;">
                        <tbody>
                            <tr>
                                <td class="o_ereset o_bg-default o_bg-center o_br o_px-md o_py-lg" align="center"
                                    background="images/hero_lines-color.png"
                                    style="line-height: 100%;background-color: #056ff0;border-radius: 6px;padding-left: 24px;padding-right: 24px;padding-top: 32px;padding-bottom: 32px;background-position: 50% 0%;background-repeat: no-repeat;font-size: 0 !important;">
                                    <!--[if mso]>
                    <table role="presentation" width="552" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tbody>
                    <tr>
                    ...
                    <![endif]-->
                                    <div class="o_col o_col-4"
                                        style="width: 100%;vertical-align: top;max-width: 368px;display: inline-block !important;">
                                        <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                                    ...
                                                    <tr>
                                                        <td class="o_bg-white o_text o_text-sans o_text-dark o_p-icon o_br-max"
                                                            ...
                                                            <img class="o_br-max"
                                                                ...
                                                                width="88" height="88" alt="Ringing Bell"
                                            ...
                                            <h3 class="o_text-headline o_text-white o_mt-md o_mb-xs"
                                                style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;font-weight: bold;color: #ffffff;margin-top: 24px;margin-bottom: 8px;font-size: 20px;line-height: 28px;">
                                                Sear {{ $candidate->name }}</h3>
                                            <p class="o_text o_text-sans o_text-white o_mb-lg"
                                                style="font-family: Arial,&quot;Helvetica Neue&quot;,Helvetica,sans-serif;word-break: break-word;color: #ffffff;margin-top: 0px;margin-bottom: 32px;font-size: 16px;line-height: 24px;">
                                                Thank you for your participation in {{ $test->name }} organized by
                                                {{ website('name') ?? title() }} in
                                                <br>
                                                <b>{{ \Carbon\Carbon::create($test->test_date)->format('Y-m-d') }}
                                                    ({{ toBS(\Carbon\Carbon::create($test->test_date)) }})</b>
                                            </p>
                                            ...
                                            <table role="presentation" align="center" width="184" cellspacing="0"
                                                cellpadding="0" border="0"
                                                style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;margin: 0 auto;">
                                                <tbody>
                                                    <tr>
                                                        <td class="o_ereset o_pt-md o_bb-white"
                                                            style="line-height: 100%;border-bottom: 4px solid #ffffff;padding-top: 24px;font-size: 0 !important;">
                                                            &nbsp; </td>
                                                    </tr>
                                                </tbody>
                                            </table>
            ...
            <![endif]-->
                    <div class="o_col-6s o_text-sans o_text-xs"
                        ...
                        <p class="o_text-muted" style="color: #687887;margin-top: 0px;margin-bottom: 0px;">You have
                            received this email because you have participated in {{ $test->name }} hosted by
                            {{ website('name') ?? title() }} on
                            {{ \Carbon\Carbon::create($test->test_date)->format('Y-m-d') }}
                            ({{ toBS(\Carbon\Carbon::create($test->test_date)) }}). <br>
                            ©{{ \Carbon\Carbon::now()->year . ' ' . website('name') ?? title() }}. | <a
                                ...
                                style="color: #687887;text-decoration: underline;outline: none;display: inline-block;"><span
                                    style="color: #687887;">Vist website</span></a> to explore more. <br>
