<div>
    ...
    <div class="report-card">
        ...
        <div style="display: flex;justify-content: space-between;margin-top: 3mm;">
            <span style="font-size: 20px;font-weight: bold;">margin: 0 3mm</span>
        ...
        <div style="margin: 3mm 0;border-bottom: 1px solid black;">
            <div style="display: flex;justify-content: space-between;padding-bottom:2mm">
                <div style="display: flex; justify-content: start;">
                    <span style="margin-right: 3mm;margin-top: 2mm;">Center Number</span>
                    <div style="border: 1px solid black;padding:2mm;min-width: 30mm;">NP012</div>
                </div>
                <div style="display: flex; justify-content: start;">
                    <span style="margin-right: 3mm;margin-top: 2mm;">Date</span>
                    <div style="border: 1px solid black;padding:2mm;min-width: 30mm;">20/AUG/2024</div>
                </div>
                <div style="display: flex; justify-content: start;">
                    <span style="margin-right: 3mm;margin-top: 2mm;">Candidate Number</span>
                    <div style="border: 1px solid black;padding:2mm;min-width: 30mm;">501244</div>
                </div>
            </div>
        </div>
        <div
            ...
            <div style="width: 160mm;">
                ...
                <div style="display: flex;justify-content:start;margin-top: 2mm;">
                    ...
                    <span
                        style="width: 60%; border: 1px solid black;background-color: rgb(178, 180, 182);padding: 2mm;">Shrestha</span>
                </div>
                <div style="display: flex;justify-content:start;margin-top: 2mm;">
                    <span style="margin-right: 2mm;width: 30%;margin-top:2mm">First Name(s)</span>
                    <span
                        style="width: 60%; border: 1px solid black;background-color: rgb(178, 180, 182);padding: 2mm;">Pratik</span>
                </div>
                <div style="display: flex;justify-content:start;margin-top: 2mm;">
                    <span style="margin-right: 2mm;width: 30%;margin-top:2mm">Candidate ID</span>
                    <span
                        style="width: 40%; border: 1px solid black;background-color: rgb(178, 180, 182);padding: 2mm;">PA1848864</span>
                </div>
            </div>
            <div>
        ...
        <div style="margin: 3mm 0;border-bottom: 1px solid black;">
            <div style="display: flex;justify-content: space-between;padding-bottom:2mm">
                <div style="display: flex; justify-content: start;">
                    ...
                    <div style="border: 1px solid black;padding:2mm;min-width: 30mm;">08/09/1998</div>
                </div>
                <div style="display: flex; justify-content: start;">
                    <span style="margin-right: 3mm;margin-top: 2mm;">Sex(M/F)</span>
                    <div style="border: 1px solid black;padding:2mm;">M</div>
                </div>
                <div style="display: flex; justify-content: start;">
        ...
        <div style="margin-top: 3mm;padding-bottom:2mm;border-bottom: 1px solid black;">
            ...
            <div style="display: flex;justify-content: space-between;margin-top: 2mm;">
                <div style="display: flex; justify-content: start;">
                    ...
                    <div style="border: 1px solid black;background-color: rgb(178, 180, 182);padding:5mm">7.0</div>
                </div>
                <div style="display: flex; justify-content: start;">
                    <span style="font-weight: bold;margin: 0 1.5mm;margin-top:5mm">Reading</span>
                    <div style="border: 1px solid black;background-color: rgb(178, 180, 182);padding:5mm">8.5</div>
                </div>
                <div style="display: flex; justify-content: start;">
                    <span style="font-weight: bold;margin: 0 1.5mm;margin-top:5mm">Writing</span>
                    <div style="border: 1px solid black;background-color: rgb(178, 180, 182);padding:5mm">6.5</div>
                </div>
                <div style="display: flex; justify-content: start;">
                ...
                <div style="display: flex; justify-content: start;">
                    ...
                    <div style="border: 1px solid black;background-color: rgb(178, 180, 182);padding:5mm">7.5</div>
                </div>
                <div style="display: flex; justify-content: start;">
                    <span style="font-weight: bold;margin: 0 1.5mm;margin-top:5mm">CEFR Level</span>
                    <div style="border: 1px solid black;background-color: rgb(178, 180, 182);padding:5mm">C1</div>
                </div>
            </div>
        </div>
        <div style="margin-top: 3mm;padding-bottom:2mm;border-bottom: 1px solid black;">
        ...
        <div style="margin-top: 15mm;display: flex;justify-content: end;">
            <div style="display: flex; justify-content: start;">
                <span style="margin-right: 3mm;margin-top: 2mm;">Date</span>
                <div style="border: 1px solid black;padding:2mm;min-width: 30mm;">21/08/2024</div>
            </div>
            <div style="display: flex; justify-content: start;">
                ...
                <div style="border: 1px solid black;padding:2mm;min-width: 60mm;background-color: rgb(178, 180, 182)">
                    kjhjkasdfhjksdfhjkd</div>
            </div>
        </div>
        <div style="margin-top: 5mm;display: flex;justify-content: center;">
            <img src="{{ asset('adminetic/static/british_council.png') }}" height="50" style="padding: 5mm;">
            <img src="{{ asset('adminetic/static/idp.png') }}" height="50" style="padding: 5mm;">
            <img src="{{ asset('adminetic/static/cambridge.png') }}" height="50" style="padding: 5mm;">
        </div>
        <span style="display:flex;justify-content:center;font-size:10px;width:100%;">IELTS is jointly owned by British
